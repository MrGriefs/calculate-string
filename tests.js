var tests = 0;
function test (subject, name, result, expected) {
    tests++;
    ...
    if (result !== expected) {
        ...
        process.exit(1);
    } else console.log('Test ' + tests + ' passed successfully.')
}
...
console.log('All tests passed successfully on node ' + process.version + '.');
process.exit(0)